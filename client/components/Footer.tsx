    ...
    <footer className="bg-primary text-primary-foreground py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-80">
              <li>
                <a href="#technology" className="hover:text-secondary transition-colors">
                  Technology
                </a>
              </li>
              <li>
                <a href="#ai" className="hover:text-secondary transition-colors">
                  Artificial Intelligence
                </a>
              </li>
              <li>
                <a href="#business" className="hover:text-secondary transition-colors">
                  Business
                </a>
              </li>
              <li>
                <a href="#marketing" className="hover:text-secondary transition-colors">
                  Marketing & SEO
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-primary-foreground/20 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm opacity-80">
            Crafted with passion | Daily insights on tech, AI, business & marketing
          </p>
        </div>
      </div>
    </footer>
